...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "COPYING", "Rakefile", "README", "lib/bcrypt.rb", "spec/bcrypt/engine_spec.rb", "spec/bcrypt/password_spec.rb", "spec/spec_helper.rb", "ext/bcrypt.c", "ext/bcrypt_ext.c", "ext/blowfish.c", "ext/blf.h", "ext/extconf.rb"]
  s.has_rdoc = true
